...
There's no build step — that's kind of the point. Open `ex_01.html` in a browser and click through with the Next/Previous buttons at the bottom of each page.
